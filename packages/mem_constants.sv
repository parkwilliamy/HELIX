...
package mem_constants;
    ...
    localparam bit mem_large = 0; // mem_large is 1 for RV32I compliance tests which simulate with 2 MB of memory, otherwise 32 KiB for synthesis
    ...
    localparam MTIME = mem_large ? 32'h00250050 : 32'h00007750,
               MTIMECMP = mem_large ? 32'h00250058 : 32'h00007758,
               LEDS = mem_large ? 32'h00250100 : 32'h00007800;
