...
VL_ATTR_COLD void Vtop_tb___024root___ctor_var_reset(Vtop_tb___024root* vlSelf) {
    ...
    vlSelf->top_tb__DOT__INST2__DOT__mret = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 12994184281922310408ull);
    ...
    vlSelf->top_tb__DOT__INST2__DOT____Vcellinp__INST4__csr_write = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 13449807774226879866ull);
